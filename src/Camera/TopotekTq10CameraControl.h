...
/// \brief Camera control adapter for Topotek TQ10N onboard capture via UDP #TP protocol.
...
public:
    ...
    ~TopotekTq10CameraControl() override;
    ...
    QString modelName() const override { return QStringLiteral("Topotek TQ10N"); }

    QString vendor() const override { return QStringLiteral("Topotek"); }
...
private:
    ...
    TopotekTq10Client* _client = nullptr;
