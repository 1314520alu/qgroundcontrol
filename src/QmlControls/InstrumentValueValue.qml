...
ColumnLayout {
    ...
    property real   _tightHeight:                   _rgFontSizeTightHeights[instrumentValueData.factValueGrid.fontSize] * fontScale
    property real   _fontSize:                      _rgFontSizes[instrumentValueData.factValueGrid.fontSize] * fontScale
