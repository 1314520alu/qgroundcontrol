...
void TopLevelViewsTest::_testNavigateViews()
{
    ...
    // Navigate through settings pages that are unconditionally visible
    {
        ...
        const QStringList settingsPages = {
            QStringLiteral("General"),    QStringLiteral("My Aircraft"), QStringLiteral("Fly View"),
            QStringLiteral("GeoView"),    QStringLiteral("Plan View"),   QStringLiteral("ADSB Server"),
            QStringLiteral("Comm Links"), QStringLiteral("App Logging"), QStringLiteral("App Log Viewer"),
            QStringLiteral("Maps"),       QStringLiteral("Remote ID"),   QStringLiteral("Telemetry"),
            QStringLiteral("Video"),      QStringLiteral("Help"),
        };
